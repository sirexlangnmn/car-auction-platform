...
db.sequelize
    .sync()
    .then(() => {
        console.log('Synced db. Connected to MySQL : ');
    })
    .catch((err) => {
...
app.get(['/listing'], (req, res) => {
    ...
    if (req.session.user === undefined) {
        ...
        if (sessionData.type === 1) {
            ...
            res.render(path.join(__dirname, '../../', 'public/view/admin-listing/index'), {
                data: sessionData,
            });
        }
...
app.get(['/dashboard'], (req, res) => {
    // res.render(path.join(__dirname, '../../', 'public/view/dashboard/index'));
...
app.get(['/create-auction'], (req, res) => {
    // res.render(path.join(__dirname, '../../', 'public/view/dashboard/index'));
     ...
     if (req.session.user === undefined) {
        ...
        res.render(path.join(__dirname, '../../', 'public/view/create-auction/index'), {
            data: sessionData,
        });
    }
});
...
app.get(['/registration'], (req, res) => {
    // res.render(path.join(__dirname, '../../', 'public/view/registration/index'));
    if (req.session.user === undefined) {
        const sessionData = {
            full_name: '',
            uuid: '',
